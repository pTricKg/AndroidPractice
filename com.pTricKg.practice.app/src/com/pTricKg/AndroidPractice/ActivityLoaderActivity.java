...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// class
		Intent firstIntent = new Intent(this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		Intent secondIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URL));
		...
		Intent chooserIntent = new Intent(Intent.createChooser(secondIntent,
				CHOOSER_TEXT));
